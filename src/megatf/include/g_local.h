...
//mtf
void	mtf_deathmsg ( float dmsg );		// deathmessage wrapper (cuz im too lazy to rename stuff)
void	lay ( );
void	unlay ( );
...
void	sandball_goal();
void	ambient_sound();
typedef void (*th_missile_func_t)(struct gedict_s *, float);
typedef void (*th_stand_func_t)(struct gedict_s *, float);
typedef void (*th_walk_func_t)(struct gedict_s *, float);
typedef void (*th_run_func_t)(struct gedict_s *, float);
// version
#define MEGATF_VERSION			"MegaTF2006 11.02.06a\n"
#define MEGATF_VER			"11.02.06a"
// misc
#define OPT_LRG		1		// Long Range Grenades Option
#define OPT_20MM	1		// 20MM Option
#endif
