...
void SP_func_door(  )
{
	...
	{
		trap_precache_sound( "doors/creekdr1.wav" );
		trap_precache_sound( "doors/creekdr2.wav" );
		self->s.v.noise1 = "doors/creekdr1.wav";
		self->s.v.noise2 = "doors/creekdr2.wav";
	}
	if ( self->armorclass == 2 )
	{
		trap_precache_sound( "doors/metaldr1.wav" );
		trap_precache_sound( "doors/metaldr2.wav" );
		self->s.v.noise1 = "doors/metaldr1.wav";
		self->s.v.noise2 = "doors/metaldr2.wav";
	}
	if ( self->armorclass == 3 )
	{
		trap_precache_sound( "doors/electdr1.wav" );
		trap_precache_sound( "doors/electdr2.wav" );
		self->s.v.noise1 = "doors/electdr1.wav";
		self->s.v.noise2 = "doors/electdr2.wav";
	}
	if ( self->armorclass == 4 )
	{
		trap_precache_sound( "doors/track_st.wav" );
		trap_precache_sound( "doors/track_e.wav" );
		self->s.v.noise1 = "doors/track_st.wav";
		self->s.v.noise2 = "doors/track_e.wav";
	}
