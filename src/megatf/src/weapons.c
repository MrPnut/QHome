...
void W_Precache(  )
{
	...
	//megatf
	//classes
	trap_precache_sound( "hknight/slash1.wav" );			// spy jump sound
	trap_precache_sound( "hknight/hit.wav" );				// spy land sound
	//engineer
	trap_precache_model( "progs/dispencr.mdl" );			// mtf engi disp model
	//misc
	trap_precache_model( "progs/spikebal.mdl" );
	trap_precache_model( "progs/syringe.mdl" );
	trap_precache_sound( "weapons/jetjump.wav" );			// jetpack sound
	trap_precache_sound( "effects/mortar.wav" );			// super nailgun sound
	trap_precache_sound( "speech/excelent.wav" );			// headshot!
	trap_precache_sound( "weapons/rifle.wav" );				// sniper fire
	
	//grenades
	trap_precache_sound ("weapons/prime.wav");				// quake2 gren sound
	//trap_precache_sound ("weapons/throw.wav");			// toss sound - already precache'd
	trap_precache_sound ("player/gas_mask.wav");			// self-gas sound
	//spiketrap
	trap_precache_sound( "shambler/smack.wav" );
	trap_precache_sound( "doors/meduse.wav" );
	//syringe
	trap_precache_sound( "player/mpain6.wav" );
	//alarm
	trap_precache_sound( "effects/beep.wav" );
	trap_precache_sound( "misc/enemy.wav" );
	//flare
	trap_precache_model( "progs/flare.spr" );				// flare sky sprite
	trap_precache_sound( "items/flare1.wav" );
	//airstrike
	trap_precache_sound( "weapons/notarget.wav" );
	trap_precache_sound( "weapons/radioair.wav" );
	trap_precache_sound( "weapons/fighter.wav" );
	trap_precache_sound( "weapons/airstrik.wav" );
	//proximity nade
	trap_precache_model( "progs/proxgren.mdl" );
	trap_precache_model( "progs/s_expl.spr" );
	trap_precache_sound( "buttons/switch02.wav" );
	// airmirv
	trap_precache_model( "progs/hgren2.mdl" );
	trap_precache_model( "progs/air-mirv.mdl" );
	trap_precache_sound( "shambler/sboom.wav" );
	trap_precache_sound( "weapons/chngnu1a.wav" );
	//lavapool
	trap_precache_model( "progs/lavapool.mdl" );
	trap_precache_model( "progs/lavaball.mdl" );
	trap_precache_sound( "weapons/throw.wav" );
	trap_precache_sound( "zombie/z_miss.wav" );
	trap_precache_sound( "misc/null.wav" );
	trap_precache_sound( "weapons/lavapool.wav" );
	// laser drone
	trap_precache_model( "progs/lsrdrone.mdl" );
	trap_precache_model( "progs/beam.mdl" );
	trap_precache_sound( "weapons/drone.wav" );
	

	// weapons
	trap_precache_model( "progs/v_mac10.mdl" );				// MAC 10
	// 20mm
	trap_precache_sound( "weapons/20mm.wav" );
	trap_precache_sound( "weapons/shell2.wav" );
	// assault cannon
	trap_precache_sound ("weapons/chngnu1a.wav");
	trap_precache_sound ("weapons/chngnd1a.wav");
	// inc cannon
	trap_precache_sound( "doors/airdoor2.wav" );
	trap_precache_model( "progs/incenrkt.mdl" );
	// grappling hook
	trap_precache_model( "progs/rope.mdl" );
	trap_precache_sound( "doors/ddoor2.wav" );
	trap_precache_sound( "weapons/retract.wav" );
	trap_precache_sound( "weapons/unreel.wav" );
	//select sounds
	trap_precache_sound( "weapons/rocklr1a.wav" );
	trap_precache_sound( "weapons/shotgr1a.wav" );		// also used with 20mm
	
	//misc
	// footsteps
	trap_precache_sound( "player/step1r.wav" );  // right, left
	trap_precache_sound( "player/step1l.wav" );
	trap_precache_sound( "player/step2r.wav" );
	trap_precache_sound( "player/step2l.wav" );
	// night vision
	trap_precache_sound( "items/nightvis.wav" );
	// ammo/weapon sounds
	trap_precache_sound( "weapons/no_ammo.wav" );		// click sound when firing while reloading
	// holo
	trap_precache_sound( "weapons/railgr1a.wav" );		// also railgun select sound
	trap_precache_sound( "ambient/100hzhum.wav" );
	// taunts
	trap_precache_sound( "speech/pantsdwn.wav" );
	trap_precache_sound( "speech/pekaboo.wav" );
	trap_precache_sound( "speech/idoasskk.wav" );
	trap_precache_sound( "speech/pathetic.wav" );
	trap_precache_sound( "speech/call911.wav" );
	trap_precache_sound( "speech/kicknads.wav" );
	trap_precache_sound( "speech/threat.wav" );
	trap_precache_sound( "speech/hey.wav" );
	trap_precache_sound( "speech/cmyhole.wav" );
	// yells
	trap_precache_sound( "speech/yell/coverme.wav" );
	trap_precache_sound( "speech/yell/overhere.wav" );
	trap_precache_sound( "speech/yell/thisway.wav" );
	trap_precache_sound( "speech/yell/followme.wav" );
	trap_precache_sound( "speech/yell/incomng.wav" );
	trap_precache_sound( "speech/yell/firehole.wav" );
	trap_precache_sound( "speech/yell/gogogo.wav" );
	trap_precache_sound( "speech/yell/lookout.wav" );
	trap_precache_sound( "speech/yell/holdup.wav" );

	// ammo cases
	trap_precache_model( "progs/20mmcase.mdl" );
	trap_precache_model( "progs/shell2.mdl" );
	trap_precache_sound( "weapons/tink2.wav" );
	// sentrygun
	trap_precache_sound( "items/repair.wav" );
	trap_precache_sound( "weapons/tnkatck4.wav" );
	trap_precache_sound( "weapons/plaser.wav" );
	trap_precache_sound( "weapons/gunidle1.wav" );
	// map ents
	trap_precache_sound( "zombie/z_hit.wav" );		// sandball
	// update score sound
	trap_precache_sound( "misc/update.wav" );
	// draw weapon sound(s)
	trap_precache_sound( "weapons/knifedrw.wav" );
	// leave game
	trap_precache_sound( "misc/eject.wav" );
}

//#include "megatf\drop1.c"
//#include "megatf\drop3.c"
//#include "megatf\common.c"
//#include "megatf\drop2.c"
...
void W_FireMedikit(  )
{
	...
	if ( trace_ent->s.v.takedamage )
	{
		if ( streq( trace_ent->s.v.classname, "building_dispenser" ) )
		{
			trace_ent->s.v.skin = 1;	// adds heal power to the dispenser
			return;
		}
		if ( streq( trace_ent->s.v.classname, "player" ) )
		{
...
void W_FireSniperRifle(  )
{
	...
	if ( g_globalvars.trace_ent )
	{
		if ( streq( trace_ent->s.v.classname, "player" ) )
		{
			...
			{
				G_sprint ( self, 1, "Stop shooting team mates!!!\n" );
				return;
			}
			...
			if ( zdif < 0 && ( trace_ent->is_squating == FALSE ) )
			{
				dam_mult = 0.5;
			...
			{
				if ( zdif > 20 || trace_ent->is_squating == TRUE )
				{
					dam_mult = 3/*2*/;
...
void W_FireAssaultCannon(  )
{
	...
	//aim( dir );
	vtemp[0] = g_globalvars.v_forward[0] * 10;
	vtemp[1] = g_globalvars.v_forward[1] * 10;
	vtemp[2] = g_globalvars.v_forward[2] * 10;
	VectorCopy( vtemp, dir );
...
void T_MissileTouch(  )
{
	...
	if ( other->s.v.health )
		TF_T_Damage( other, self, PROG_TO_EDICT( self->s.v.owner ), damg, 0, 4 );
...
void launch_spike( vec3_t org, vec3_t dir )
{
	...
	VectorScale( dir, 2000, newmis->s.v.velocity );
}
...
void W_FireMTFSpikes( float ox )
{
	vec3_t  dir, tmp;

	makevectors( self->s.v.v_angle );
	if ( self->s.v.ammo_nails >= 1 && self->current_weapon == WEAP_SUPER_NAILGUN )
	{
...
//			self->s.v.weaponmodel = "progs/v_axe.mdl";
		...
		break;
	case WEAP_HOOK:
		self->s.v.currentammo = self->s.v.ammo_cells/*0*/;
	...
	case WEAP_MAC10:
		...
		if ( !( self->tfstate & TFSTATE_RELOADING ) )
		{
			self->s.v.weaponmodel = "progs/v_mac10.mdl";
			self->s.v.weaponframe = 0;
		}
		items |= 512;
		self->s.v.weapon = 4;
								...
								else
								{
									...
									else
									{
										...
										else
										{
											...
											{
												if ( self->s.v.ammo_nails >= 1 && ( it & WEAP_MAC10 ) )
													return WEAP_MAC10;
												else
												{
													if ( it & WEAP_AXE )
...
void W_Reload_shotgun(  )
{
	...
	sound ( owner, 1, "weapons/pkup.wav", 1, 1 );
...
void W_Reload_grenade_launcher(  )
{
	...
	sound( owner, 1, "weapons/rocklr1a.wav", 1, 1 );
	G_sprint( owner, 0, "finished reloading\n" );
	dremove( self );
	owner->StatusRefreshTime = g_globalvars.time + 0.1;
}
...
void W_Attack(  )
{
	...
	//if ( self->s.v.weaponmodel == "progs/proxgren.mdl" ) {
		Prox ( );
		Attack_Finished (0.2);
		self->s.v.impulse = 0;
		return;
	...
	case WEAP_SPANNER:
		...
		break;
	case WEAP_HOOK:
		if ( !self->hook_out &&  self->s.v.ammo_cells > 24 && !self->is_feigning )
		{
			player_chain1(  );
			self->immune_to_check = g_globalvars.time + 4;
			sound( self, 1, "weapons/sniper.wav", 1, 1 );
		...
		{
			G_sprint( self, 2, "Not enough power cells...\n" );
			Attack_Finished( 1.0 );
		}
		break;
	case WEAP_SHOTGUN:
...
/*	case WEAP_SUPER_NAILGUN:
	...
	case WEAP_GRENADE_LAUNCHER:
		...
		W_FireGrenade(  );
		if ( self->option == OPT_LRG )
			self->reload_grenade_launcher += 2;
		else
	...
	case WEAP_AUTO_RIFLE:
		...
		break;
	case WEAP_ASSAULT_CANNON:
		if ( ( self->playerclass == PC_HVYWEAP ) && ( self->option4 == OPT_20MM ) ) {
			W_FireBigAss ( );
			Attack_Finished (0.2);
			//self.impulse = 0;
			break;
...
void W_PrintWeaponMessage(  )
{
	...
	case WEAP_HOOK:
		...
		break;
	case WEAP_GRENADE_LAUNCHER:
		if ( self->weaponmode == GL_NORMAL && self->option != OPT_LRG )
		...
		else
		{
			...
			else
			{
				...
				{
					if ( self->weaponmode == GL_NORMAL && self->option == OPT_LRG )
						G_sprint( self, 1, "Long-range grenade mode\n" );
				}
			}
		}
		break;
...
void W_ChangeWeapon(  )
{
	...
	if ( self->s.v.impulse == 1 )
	{
		if ( !( it & ( 1 | 2 | 4 | 16 | 8 ) ) )
			have_weapon = 0;
		if ( fl != 16 && self->playerclass != PC_SPY )
			sound( self, 1, "weapons/knifedrw.wav", 1, 1 );
				...
				if ( self->s.v.impulse == 2 )
				{
					if ( it & 32 )
					{
						...
						if ( self->s.v.ammo_shells < tf_data.snip_ammo )
							...
							sound ( self, 1, "weapons/shotgr1a.wav", 0.8, 1 );
					} else
					{
						if ( it & 128 )
						{
...
//							fl = 512;
						...
						} else
						{
							...
							{
								if ( /*it & 4096*/self->playerclass == PC_MEDIC ) {
									fl = 1024;
									...
									if ( it & 2048 ) {
										...
										if ( self->s.v.ammo_rockets < 3 )
											...
											sound (self, 1, "weapons/rocklr1a.wav", 0.8, 1);
										self->weaponmode = 0;
										self->option = OPT_LRG;
									}
								}
							} else
							{
								...
								} else
								{
										...
										} else
										{
											...
											} else
											{
												if ( it & 32768 )
												{
													if ( self->option4 )
													{
														self->option4 = 0;	// regular ass. cannon
														G_sprint ( self, 2, "Assault cannon selected\n" );
														if ( self->s.v.ammo_cells < 4 )
															am = 2;
													}
													else
													{
														self->option4 = OPT_20MM;
														G_sprint ( self, 2 , "20mm cannon selected\n" );
													}
													fl = 32768;
													if ( self->s.v.
													     ammo_shells
									...
									{
										if ( self->s.v.impulse == 8 && self->playerclass == PC_SPY )
										{
											//if (self->playerclass == PC_SPY)
											//{
												fl = 1;
	...
	if ( am == 1 && (self->playerclass != PC_SPY && fl != 1))
	{
		G_sprint( self, 2, "not enough ammo.\n" );
		return;
	}
/*	if ( ( self->playerclass == PC_SPY && fl == 1 ) && self->s.v.ammo_cells < 25 )
	{
		G_sprint( self, 2, "not enough ammo.\n" );
		return;
	}*/
							...
							} else
							{
								...
								} else
								{
									     ...
									     WEAP_SUPER_SHOTGUN )
									{
										...
										self->current_weapon = WEAP_MAC10;
										if ( self->s.v.ammo_nails < 1 )
											am = 1;
									} else
									{
																	...
																	} else
																	{
																		if ( self->current_weapon == WEAP_ASSAULT_CANNON )
																		{
																			self->
																			    ...
																			    =
																			    WEAP_HOOK;
																			if ( /*self->s.v.ammo_cells < 25*/self->playerclass != PC_SPY )//!tf_data.allow_hook )
																				am = 1;
																		} else
																		{
																			...
																			else
																			{
																				...
																				else
																				{
																					...
																					{
																						if ( self->current_weapon == WEAP_MAC10 && self->playerclass == PC_SPY )
																							self->
																								current_weapon
																								=
																								WEAP_HOOK;
...
void ImpulseCommands(  )
{
	...
	case 152:
		...
		break;
	case 154:
		G_sprint( self, 2, "--- Airscout Info ---\n" );
		G_sprint( self, 2, "Def: A Scout that can jump very high\n" );
		G_sprint( self, 2, "Cmd: 'jetjump' or Impulse 155.\n" );
		G_sprint( self, 2, "    Uses 25 battery cells per jump.\n" );
		G_sprint( self, 2, "    Aim higher than you want to go.\n" );
		G_sprint( self, 2, "Use:  Must be a scout,\n" );
		break;
	case 155:
	...
	case 158:
		if ( self->is_squating == TRUE )
		{
			...
			self->s.v.frame = 0;
			unlay ( );
			G_sprint ( self, 2, "Standing mode, (normal)\n" );
		}
		else
		{
			self->is_squating = TRUE;
			lay ( );
			G_sprint ( self, 2, "Laying mode, (stop walking to lay)\n" );
		}
		break;
	case 194:
		if ( self->playerclass )
	...
	case 61:
		if ( self->playerclass == PC_SNIPER )
		{
			if ( self->option4 == 1 )
			{
				G_sprint (self, 2, "Laser Sight On\n");
				self->option4 = 0;
			}
			else
			{
				G_sprint (self, 2, "Laser Sight Off\n");
				self->option4 = 1;
			}
		}
		break;
	...
	case 53:
		if (self->playerclass == 0)
			break;
		self->current_menu = MENU_TAUNT;
		self->menu_count = MENU_TAUNT;
		break;
	case 56:
		if (self->playerclass == 0)
			break;
		self->current_menu = MENU_YELL;
		self->menu_count = MENU_YELL;
		break;
	case 57:
		if (self->playerclass == 0)
			break;
		self->current_menu = MENU_DROPSTUFF;
		self->menu_count = MENU_DROPSTUFF;
		break;	
	// taunts
	case 156:
		if (self->last_saveme_sound <= g_globalvars.time) {
			self->last_saveme_sound = g_globalvars.time + 5;
			muzzleflash( );
			sound( self, 0, "speech/hey.wav", 0.7, 0 );
		}
		break;
	case 58:
		if (self->last_saveme_sound <= g_globalvars.time) {
			self->last_saveme_sound = g_globalvars.time + 5;
			muzzleflash( );
			sound( self, 0, "speech/threat.wav", 0.7, 0 );
		}
		break;
	case 157:
		if (self->last_saveme_sound <= g_globalvars.time) {
			self->last_saveme_sound = g_globalvars.time + 5;
			muzzleflash( );
			sound( self, 0, "speech/cmyhole.wav", 0.7, 0 );
		}
		break;
	case 250:
		if (self->last_saveme_sound <= g_globalvars.time) {
			self->last_saveme_sound = g_globalvars.time + 5;
			muzzleflash( );
			sound( self, 1, "speech/pantsdwn.wav", 1, 1 );
			G_sprint( self, 1, MEGATF_VERSION );
		}
		break;
	// drop1
	case 190:
		if (!tf_data.drop1) {
			G_sprint (self, 2, "Type 1 weapons disabled by Admin!\n");
			break;
		}
		if ( ( int ) self->s.v.flags & FL_ONGROUND )	// player must be on ground to drop
		{
			if ( self->playerclass == PC_SCOUT )
				C_Mine ( );
