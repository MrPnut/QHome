...
// Note from XavioR:
//  Quite a few of these models are no longer used in mtf. I've weeded
// out the ones I could find and left others. Modders decide. 
...
// player gib sounds
	...
	trap_precache_sound( "player/gib2.wav" );	// mtf gib sounds
	trap_precache_sound( "player/gib3.wav" );
...
// player pain sounds
	...
	trap_precache_sound( "player/mpain6.wav" );	// mtf pain
...
// player death sounds
	...
	trap_precache_sound( "player/mdeath5.wav" );	// heart stopped
	trap_precache_sound( "player/malive5.wav" );	// oops - i'm alive!
...
/////////////////////////TF///////////////////
	...
	trap_precache_model( "progs/disp.mdl" );		// not used in mtf - should it still be precache'd?
