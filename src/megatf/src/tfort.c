...
const class_settings_t class_set[] = {
	...
	{
	 1,			//bitmask
	 75, 400, 400,		//maxhelth ,speeds
	 WEAP_AXE | WEAP_SHOTGUN | WEAP_MAC10/*WEAP_NAILGUN*/, WEAP_MAC10/*WEAP_NAILGUN*/,	//weapon: carried, start
	 25, 100, 0, 100, 0, 0,	// ammo
	 ...
	 0, 25, 50,		//AC, val,max
	 0.3, 0.3,		//AT ,Aallow
	 WEAP_AXE | WEAP_SHOTGUN | WEAP_MAC10/*WEAP_NAILGUN*/,	//items allowed
	 IT_SHOTGUN | IT_NAILGUN,	//items
	 "Scout", "airscout"/*"tf_scout"*/, //"tf_scout",
	 {"sk_t1_scout", "sk_t2_scout", "sk_t3_scout", "sk_t4_scout"}
	 },
	{
	 2,			//bitmask
	 90, 300, 300,		//maxhelth ,speeds
	 WEAP_SNIPER_RIFLE | WEAP_AUTO_RIFLE | WEAP_AXE | WEAP_MAC10/*WEAP_NAILGUN*/,
	 ...
	 0, 0, 50,		//AC, val,max
	 0.3, 0.3,		//AT ,Aallow
	 WEAP_SNIPER_RIFLE | WEAP_AUTO_RIFLE | WEAP_AXE | WEAP_MAC10/*WEAP_NAILGUN*/,	//items allowed
	 ...
	 },
	{
	 ...
	 50, 150, 0, 0, 0, 200,	// ammo
	 75, 250/*150*/, 25, 60, 0, 200,	//maxammo
	 3, 2,			//num grens
	 ...
	 },
	{
	 ...
	 WEAP_ASSAULT_CANNON | WEAP_AXE | WEAP_SHOTGUN | WEAP_SUPER_SHOTGUN | WEAP_MAC10,
	 WEAP_ASSAULT_CANNON,	//weapon: carried, start
	 200, 100, 0, 24, 0, 0,	// ammo
	 250, 250, 10, 50, 0, 0,	//maxammo
	 4, 1,			//num grens
	 GR_TYPE_NORMAL, GR_TYPE_MIRV,	//newgren types
	 GR_TYPE_NORMAL, GR_TYPE_MIRV,	//oldgren types
	 0, 0,			//tf_items,tf_items_flags
	 ...
	 0.8, 0.8,		//AT ,Aallow
	 WEAP_ASSAULT_CANNON | WEAP_AXE | WEAP_SHOTGUN | WEAP_SUPER_SHOTGUN | WEAP_MAC10,	//items allowed
	 IT_SHOTGUN | IT_SUPER_SHOTGUN | IT_ROCKET_LAUNCHER,	//items
	 ...
	 },
	{
	 ...
	 WEAP_FLAMETHROWER,	//weapon: carried, start
	 20, 0, 20, 150, 0, 0,	// ammo
	 40, 50, 40, 250, 0, 0,	//maxammo
	 1, 4,			//num grens
	 GR_TYPE_NORMAL, GR_TYPE_NAPALM,	//newgren types
	 GR_TYPE_NORMAL, GR_TYPE_NAPALM,	//oldgren types
	 0, 0,			//tf_items,tf_items_flags
	 AT_SAVEFIRE, 70, 150,	//AC, val,max
	 0.5, 0.5,		//AT ,Aallow
	 ...
	 },
	{
	 256,			//bitmask
	 90, 300, 300,		//maxhelth ,speeds
	 WEAP_AXE | WEAP_TRANQ | WEAP_SUPER_SHOTGUN | WEAP_MAC10/*WEAP_NAILGUN*/ | WEAP_HOOK,
	 WEAP_TRANQ,		//weapon: carried, start
	 40, 25, 0, 25, 0, 0,	// ammo
	 40, 50, 15, 30, 0, 0,	//maxammo
	 2, 2,			//num grens
	 ...
	 0, 25, 100,		//AC, val,max
	 0.3, 0.3,		//AT ,Aallow
	 WEAP_AXE | WEAP_TRANQ | WEAP_SUPER_SHOTGUN | WEAP_MAC10/*WEAP_NAILGUN*/ | WEAP_HOOK,	//items allowed
	 IT_SHOTGUN | IT_SUPER_SHOTGUN | IT_NAILGUN | IT_HOOK,	//items
	 "Spy", "tf_spy", //"tf_spy",
...
void UseSpecialSkill(  )
{
	...
	case PC_SCOUT:
		...
		self->s.v.impulse = IMPULSE_JETJUMP;
		break;
...
//				    ( g_globalvars.v_forward[2] * 600 + g_globalvars.v_up[2] * 25 ) * 700;
				newmis->s.v.velocity[2] = 0;
				aim( newmis->s.v.velocity );
				newmis->s.v.velocity[0] =
				    ( g_globalvars.v_forward[0] * 1300 );
				newmis->s.v.velocity[1] =
				    ( g_globalvars.v_forward[0] * 1300 );
				newmis->s.v.velocity[2] =
				    ( g_globalvars.v_forward[0] * 1300 );
...
//	sound( user, 1, "weapons/grenade.wav", 1, 1 );
	sound( user, 3, "weapons/throw.wav", 1, 1 );
// sound (user, 1, "weapons/ax1.wav", 1, 1);
	...
	case GR_TYPE_FLARE:
		...
		newmis->s.v.movetype = 5;
		newmis->s.v.velocity[2] = 0;
		aim( newmis->s.v.velocity );
		newmis->s.v.velocity[0] =
		    ( newmis->s.v.velocity[0] * 1300 );
		newmis->s.v.velocity[1] =
		    ( newmis->s.v.velocity[1] * 1300 );
		newmis->s.v.velocity[2] =
		    ( newmis->s.v.velocity[2] * 1300 );
		//printthrowmsg = false;
		newmis->s.v.solid = 1;
		break;
...
/*	if ( p->leg_damage )
	...
	if ( p->leg_damage )
	{
		if ( p->leg_damage > 4 )
			p->leg_damage = 4;
		p->maxfbspeed = p->maxfbspeed * ( ( 10 - p->leg_damage ) * .05 );
